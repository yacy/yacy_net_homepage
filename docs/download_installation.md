...
You can download and build your own YaCy with these simple steps. This is probably the best and the easiest way for everyone who knows how to use a command line interface. You need:
